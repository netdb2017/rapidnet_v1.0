...
const string Pathvector::BESTPATH = "bestPath";
const string Pathvector::LINK = "link";
const string Pathvector::PATH = "path";
const string Pathvector::PATHDELETE = "pathDelete";
const string Pathvector::R2LOCAL1R2LINKZSEND = "r2Local1r2linkZsend";
const string Pathvector::R2LOCAL2PATHSEND = "r2Local2pathsend";
const string Pathvector::R2LINKZ = "r2linkZ";
const string Pathvector::R2LINKZDELETE = "r2linkZDelete";

NS_LOG_COMPONENT_DEFINE ("Pathvector");
NS_OBJECT_ENSURE_REGISTERED (Pathvector);

TypeId
Pathvector::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::rapidnet::pathvector::Pathvector")
    .SetParent<RapidNetApplicationBase> ()
    .AddConstructor<Pathvector> ()
    ;
  return tid;
}
...
void
Pathvector::StartApplication (void)
{
  NS_LOG_FUNCTION_NOARGS ();

  RapidNetApplicationBase::StartApplication ();
  RAPIDNET_LOG_INFO("Pathvector Application Started");
}

void
Pathvector::StopApplication ()
{
  NS_LOG_FUNCTION_NOARGS ();

  RapidNetApplicationBase::StopApplication ();
  RAPIDNET_LOG_INFO("Pathvector Application Stopped");
}

void
Pathvector::InitDatabase ()
{
...
void
Pathvector::DemuxRecv (Ptr<Tuple> tuple)
{
...
void
Pathvector::R1Eca0Ins (Ptr<Tuple> link)
{
...
void
Pathvector::R1Eca0Del (Ptr<Tuple> link)
{
...
void
Pathvector::R2Local1Eca0RemoteIns (Ptr<Tuple> r2Local1r2linkZsend)
{
...
void
Pathvector::R2Local1Eca0RemoteDel (Ptr<Tuple> r2linkZDelete)
{
...
void
Pathvector::R2Local1Eca0Ins (Ptr<Tuple> link)
{
...
void
Pathvector::R2Local1Eca0Del (Ptr<Tuple> link)
{
...
void
Pathvector::R2Local2Eca0RemoteIns (Ptr<Tuple> r2Local2pathsend)
{
...
void
Pathvector::R2Local2Eca0RemoteDel (Ptr<Tuple> pathDelete)
{
...
void
Pathvector::R2Local2Eca0Ins (Ptr<Tuple> r2linkZ)
{
...
void
Pathvector::R2Local2Eca0Del (Ptr<Tuple> r2linkZ)
{
...
void
Pathvector::R2Local2Eca1Ins (Ptr<Tuple> bestPath)
{
...
void
Pathvector::R2Local2Eca1Del (Ptr<Tuple> bestPath)
{
...
void
Pathvector::R3eca (Ptr<Tuple> path)
{
...
void
Pathvector::R3eca2 (Ptr<Tuple> path)
{
