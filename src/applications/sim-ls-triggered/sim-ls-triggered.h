...
#ifndef SIMLSTRIGGERED_H
#define SIMLSTRIGGERED_H
...
class SimLsTriggered : public Discovery
{
public:
...
protected:
  ...
  virtual void R13Eca1Ins (Ptr<Tuple> tLink);

  virtual void R13Eca1Ref (Ptr<Tuple> tLink);
